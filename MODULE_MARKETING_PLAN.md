...
# ФАЗА 5 — Страницы сравнения с конкурентами ❌ ОТМЕНЕНА 21.08.2026

> **Не выполнять.** Решением владельца от 21.08.2026 сайт до запуска не упоминает
> конкурентов ни в каком виде: раздел `/sravnenie` снят с публикации, три страницы
> сравнений и статья `sravnenie-komplid-cus` перенесены в `content/_otlozheno/`
> (порядок возврата — в README этой папки). Действующее правило — `CLAUDE.md` §9
> и §16.4. Раздел ниже сохранён как описание того, что было сделано и что
> придётся восстанавливать, если решение изменится.
