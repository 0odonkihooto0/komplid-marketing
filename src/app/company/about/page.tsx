...
export const metadata: Metadata = {
  title: 'О компании Komplid — ERP для строительных проектов',
  description:
    'Komplid — российская ERP-платформа для управления строительством: исполнительная документация, сметы, журналы, стройконтроль и ТИМ в одной системе. Данные в РФ, соответствие 152-ФЗ.',
  ...
  return (
    <>
      ...
      <div className="section" style={{ borderBottom: '1px solid var(--border)' }}>
        <div className="wrap">
          <span className="eyebrow">Komplid · О компании</span>
          <h1
          ...
          <p className="max-w-2xl text-lg" style={{ color: 'var(--ink-soft)' }}>
            Komplid объединяет исполнительную документацию, сметы, журналы работ, стройконтроль и
            ТИМ в одной системе. Мы делаем инструмент, который уже знает про АОСР, КС-2/КС-3,
            приказ №344/пр и маршруты согласования с ЭЦП — а не абстрактный «таск-трекер».
          </p>
        </div>
      </div>
      ...
      <div className="section wrap" style={{ maxWidth: 760 }}>
        ...
        <p className="mb-6 leading-relaxed" style={{ color: 'var(--ink-soft)' }}>
          ...
          сверяются неделями, журналы дублируются на бумаге. Komplid связывает документы, сроки и
