...
/**
 * Пересборка таблицы-зеркала на Яндекс.Диске из хранилища заявок.
 *
 * Когда нужна: Диск был недоступен, токен протух или строку потеряла гонка
 * двух одновременных заявок — таблица разошлась с хранилищем. Роут читает
 * все заявки из S3 (или с диска) и перезаписывает файл целиком.
 *
