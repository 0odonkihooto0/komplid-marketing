...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      'Это URL, по которому заказчик или инвестор может открыть вашу смету в браузере без регистрации в «Комплид». Смета отображается в читаемом формате с итогами. Вы контролируете доступ: можно ограничить по времени или отозвать ссылку в любой момент.',
  },
  {
