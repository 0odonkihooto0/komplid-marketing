...
const PACKAGES: ProfiPackage[] = [
  {
    ...
    title: 'Для сметчика',
    description:
      'Импорт из Гранд-Сметы, сравнение версий, публичные ссылки для заказчика, база ФСНБ-2022',
    priceFrom: 1900,
  },
  {
    slug: 'pto',
    ...
    description: 'АОСР, ОЖР, КС-2/КС-3 по приказу №344/пр, маршруты согласования, подпись с GPS',
    priceFrom: 1900,
  },
  {
    slug: 'prorab',
