    ...
    >
      <div className="wrap">
        <div className="section-head" style={{ textAlign: 'center', margin: '0 auto 32px' }}>
          <span className="eyebrow" style={{ justifyContent: 'center' }}>
            Тарифы Прораб-Журнала
          </span>
          <h2 style={{ marginLeft: 'auto', marginRight: 'auto' }}>
            Начните бесплатно, платите когда нужно больше
          </h2>
          <p style={{ marginLeft: 'auto', marginRight: 'auto' }}>
            Все тарифы включают PWA без App Store. Работает офлайн на любом смартфоне.
          </p>
        </div>
      ...
      <style>{`
        @media (max-width: 900px) {
          #prorab-pricing-grid { grid-template-columns: 1fr !important; }
        }
      `}</style>
    </section>
  );
